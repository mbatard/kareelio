...
type Config struct {
	...
	JobApplicationBackfill              bool
	JobApplicationBackfillDryRun        bool
	JobApplicationRequireEncryptedReads bool
}
...
func Load() *Config {
	return &Config{
		...
		JobApplicationBackfill:              getEnvBool("JOB_APPLICATIONS_BACKFILL", false),
		JobApplicationBackfillDryRun:        getEnvBool("JOB_APPLICATIONS_BACKFILL_DRY_RUN", true),
		JobApplicationRequireEncryptedReads: getEnvBool("JOB_APPLICATIONS_REQUIRE_ENCRYPTED_READS", false),
	}
}
